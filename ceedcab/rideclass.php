...
{  
    ...
    {      
        ...
        if($result->num_rows > 0){
            ...
            if($i==0){
                $sqlii = "INSERT INTO `tbl_ride`(`ride_date`, `from_loc`, `to_loc`,`Cab_type` ,`total_distance`, `luggage`, `total_fare`, `customer_user_id`) VALUES ('".date("Y/m/d")."', '".$pick."', '".$drop."', '".$cab."', '".$distance."', '".$luggage."','".$fare."', '".$userid."')";
