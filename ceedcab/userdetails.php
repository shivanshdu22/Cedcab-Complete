...
<html lang="zxx">
    ...
    <body>
       <?php include "indexheader.php";?>
		...
		<div class="jumbotron">
		<div id="userdetails">
                <p><h3><span id="userheading">User Details</span></h3></p>
                <p><span id="userheading userid">User Id : </span><div id="UserID"><?php echo $ud['user_id'];?></div></p>
                <p><span id="userheading username">Username : </span> <div id="UserName"> <?php echo $ud['user_name'];?></div></p>
                <p><span id="userheading name">Name : </span><div id="Name"> <?php echo $ud['name'];?></div></p> 
                <p><span id="userheading dos">Date of Sign-Up : </span><div id="DOS"> <?php echo $ud['Date_of_signup'];?></div></p>
                <p><span id="userheading mob">Mobile : </span><div id="mobile"><?php echo $ud['mobile'];?></div></p>
